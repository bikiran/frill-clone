...
export default function OrderDetailPage() {
  ...
  const openPrint = (docType: 'packing_slip' | 'label') => { if (companyId) window.open(`/admin/orders/print?doc=${docType}&company=${encodeURIComponent(companyId)}&ids=${orderId}`, '_blank') }
