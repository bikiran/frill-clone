                  ...
                  <tbody>
                    {benefitFactors.map((f, i) => (
                      <tr key={i} style={{ borderBottom: '1px solid var(--border)' }}>
                        ...
                        <td style={{ padding: '10px 16px' }}><select value={f.type} onChange={e => { const n=[...benefitFactors]; n[i]={...n[i],type:e.target.value}; setBenefitFactors(n) }} style={{ border:'1px solid var(--border)', borderRadius:6, padding:'5px 26px 5px 10px', fontSize:13, outline:'none', appearance:'none', WebkitAppearance:'none', MozAppearance:'none', background:'#fff url("data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20width%3D%2710%27%20height%3D%276%27%3E%3Cpath%20d%3D%27M0%200l5%206%205-6z%27%20fill%3D%27%236b6b70%27%2F%3E%3C%2Fsvg%3E") no-repeat right 9px center', cursor:'pointer' }}>{['Vote Count','Percentage','1-5','0-10','Currency'].map(t => <option key={t}>{t}</option>)}</select></td>
                        <td style={{ padding: '10px 16px' }}><select value={f.weight} onChange={e => { const n=[...benefitFactors]; n[i]={...n[i],weight:parseInt(e.target.value)}; setBenefitFactors(n) }} style={{ border:'1px solid var(--border)', borderRadius:6, padding:'5px 26px 5px 10px', fontSize:13, outline:'none', appearance:'none', WebkitAppearance:'none', MozAppearance:'none', background:'#fff url("data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20width%3D%2710%27%20height%3D%276%27%3E%3Cpath%20d%3D%27M0%200l5%206%205-6z%27%20fill%3D%27%236b6b70%27%2F%3E%3C%2Fsvg%3E") no-repeat right 9px center', cursor:'pointer' }}>{[10,20,25,33,50,75,100].map(w => <option key={w} value={w}>{w}%</option>)}</select></td>
                  ...
                  <tbody>
                    {costFactors.map((f, i) => (
                      <tr key={i} style={{ borderBottom: '1px solid var(--border)' }}>
                        ...
                        <td style={{ padding: '10px 16px' }}><select value={f.type} onChange={e => { const n=[...costFactors]; n[i]={...n[i],type:e.target.value}; setCostFactors(n) }} style={{ border:'1px solid var(--border)', borderRadius:6, padding:'5px 26px 5px 10px', fontSize:13, outline:'none', appearance:'none', WebkitAppearance:'none', MozAppearance:'none', background:'#fff url("data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20width%3D%2710%27%20height%3D%276%27%3E%3Cpath%20d%3D%27M0%200l5%206%205-6z%27%20fill%3D%27%236b6b70%27%2F%3E%3C%2Fsvg%3E") no-repeat right 9px center', cursor:'pointer' }}>{['0-5','1-5','Percentage','Hours','Days'].map(t => <option key={t}>{t}</option>)}</select></td>
                        <td style={{ padding: '10px 16px' }}><select value={f.weight} onChange={e => { const n=[...costFactors]; n[i]={...n[i],weight:parseInt(e.target.value)}; setCostFactors(n) }} style={{ border:'1px solid var(--border)', borderRadius:6, padding:'5px 26px 5px 10px', fontSize:13, outline:'none', appearance:'none', WebkitAppearance:'none', MozAppearance:'none', background:'#fff url("data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20width%3D%2710%27%20height%3D%276%27%3E%3Cpath%20d%3D%27M0%200l5%206%205-6z%27%20fill%3D%27%236b6b70%27%2F%3E%3C%2Fsvg%3E") no-repeat right 9px center', cursor:'pointer' }}>{[10,20,25,33,50,75,100].map(w => <option key={w} value={w}>{w}%</option>)}</select></td>
