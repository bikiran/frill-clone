...
const icons: Record<string, React.JSX.Element> = {
  ...
  // Brand marks — Reviews (Google "G") and Social Engagement (Meta), drawn
  // monochrome (currentColor) so they match the rest of the sidebar icons.
  google: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z"/></svg>,
  meta: <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M6.915 4.03c-1.968 0-3.683 1.28-4.871 3.113C.704 9.208 0 11.883 0 14.449c0 .706.07 1.369.21 1.973a6.624 6.624 0 0 0 .265.86 5.297 5.297 0 0 0 .371.761c.696 1.159 1.818 1.927 3.593 1.927 1.497 0 2.633-.671 3.965-2.444.76-1.012 1.144-1.626 2.663-4.32l.756-1.339.186-.325c.061.1.121.196.183.3l2.152 3.595c.724 1.21 1.665 2.463 2.47 3.315 1.145 1.211 2.115 1.601 3.652 1.601 1.32 0 2.363-.732 3.055-1.792.372-.573.712-1.288.98-2.116.276-.856.408-1.72.408-2.688 0-2.566-.704-5.243-2.044-7.306-1.188-1.831-2.903-3.111-4.871-3.111-1.523 0-2.744.734-3.885 2.113-.734.886-1.379 1.916-2.032 3.017l-.85 1.4-.85-1.4c-.653-1.101-1.298-2.131-2.032-3.017C9.659 4.764 8.438 4.03 6.915 4.03Zm.006 2.352c.888 0 1.61.457 2.36 1.354.51.61 1.058 1.475 1.673 2.51l.796 1.337-.796 1.337c-1.317 2.213-1.803 3.026-2.42 3.83-.83 1.08-1.42 1.42-2.202 1.42-.804 0-1.318-.35-1.638-.878-.267-.44-.44-1.043-.44-1.842 0-2.084.6-4.36 1.616-5.945.79-1.235 1.808-2.12 2.94-2.12Zm10.157 0c1.132 0 2.15.885 2.94 2.12 1.016 1.585 1.616 3.861 1.616 5.945 0 .8-.173 1.402-.44 1.842-.32.527-.834.878-1.638.878-.782 0-1.372-.34-2.202-1.42-.617-.804-1.103-1.617-2.42-3.83l-.796-1.337.796-1.337c.615-1.035 1.163-1.9 1.673-2.51.75-.897 1.472-1.354 2.36-1.354Z"/></svg>,
  ...
  command: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="2"/><path d="M16.24 7.76a6 6 0 0 1 0 8.49"/><path d="M7.76 16.24a6 6 0 0 1 0-8.49"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M4.93 19.07a10 10 0 0 1 0-14.14"/></svg>,
  orders: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>,
  shipping: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13"/><path d="M16 8h4l3 3v5h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>,
  payments: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="6" y1="15" x2="10" y2="15"/></svg>,
}
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Shipping', href: '/admin/orders/shipping', icon: 'shipping' },
    ],
  },
  {
    label: 'Inbox & CRM',
  ...
  },
  {
    label: 'Insights',
    items: [
      { label: 'Command Centre', href: '/admin/command-centre', icon: 'command' },
          ...
          {isSuperAdmin && (
            <div style={{ marginBottom: 20 }}>
              ...
              <Link href="/admin/legal"
                style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '7px 10px', borderRadius: 8, fontSize: 13, textDecoration: 'none', color: 'var(--slate)', background: 'transparent' }}>
                <span style={{ flexShrink: 0, display: 'flex', opacity: 0.65 }}>{icons.legal || icons.settings}</span>
                Legal Pages
              </Link>
            </div>
          )}
