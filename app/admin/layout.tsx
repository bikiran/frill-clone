...
const icons: Record<string, React.JSX.Element> = {
  ...
  meta: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 12C8.5 5.5 4 7 4 12C4 17 8.5 18.5 12 12C15.5 5.5 20 7 20 12C20 17 15.5 18.5 12 12Z"/></svg>,
