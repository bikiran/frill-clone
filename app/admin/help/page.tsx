...
const SEED_ARTICLES = [
  ...
  { title: 'Embedding the Frill widget', content: `# Embedding the Frill widget\n\nAdd Frill to your app with a simple JavaScript snippet.\n\n## Installation\n\nPaste this code before the closing \`</body>\` tag:\n\n\`\`\`html\n<script src="https://yourapp.frill.co/embed.js"></script>\n\`\`\`\n\n## Configuration\n\nCustomize the widget color, position, and features.\n\n## SSO\n\nPass user data to Frill so users are automatically logged in.`, category: 'Integrations', status: 'published', featured: true, views: 203, likes: 41 },
