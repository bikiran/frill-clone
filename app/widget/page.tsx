                  ...
                  {chatMessages2.map((msg: any, i) => {
                    ...
                    return (
                      <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: isAgent ? 'flex-start' : 'flex-end', position: 'relative' }}
                        ...
                        {/* Be honest about who wrote this. People deserve to know
                            they're talking to an AI, and that it can be wrong. */}
                        {msg.is_ai && (
                          <p style={{ margin: '2px 4px 0', fontSize: 9, color: '#a78bfa', display: 'flex', alignItems: 'center', gap: 3 }}>
                            <svg width="9" height="9" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l1.6 5.3L19 9l-5.4 1.7L12 16l-1.6-5.3L5 9l5.4-1.7z"/></svg>
