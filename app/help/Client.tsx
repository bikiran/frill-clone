  ...
  return (
    <div className="min-h-screen" style={{ background: darkMode ? '#111214' : 'var(--canvas)', filter: darkMode ? 'invert(0.92) hue-rotate(180deg)' : 'none' }}>
      ...
      <div className="mx-auto px-6" style={{ maxWidth: 1240, paddingTop: 32, paddingBottom: 40 }}>
        ...
        {/* Contact / Ticketing */}
        <div className="mt-12 mb-6 grid md:grid-cols-3 gap-4 md:gap-6">
          <div className="bg-white rounded-2xl border p-5 md:p-6 text-center" style={{ borderColor: 'var(--border)' }}>
            ...
            <button onClick={() => window.dispatchEvent(new CustomEvent('colvy-open-chat'))} className="px-4 py-2 rounded-lg text-sm font-semibold text-white cursor-pointer w-full" style={{ background: 'var(--coral)' }}>
              Start Chat
            </button>
          </div>
          <div className="bg-white rounded-2xl border p-5 md:p-6 text-center" style={{ borderColor: 'var(--border)' }}>
          ...
          <div className="bg-white rounded-2xl border p-5 md:p-6 text-center" style={{ borderColor: 'var(--border)' }}>
            ...
            <a href={helpEmail ? `mailto:${helpEmail}` : '/help/ticket'} className="px-4 py-2 rounded-lg text-sm font-semibold border cursor-pointer w-full block" style={{ borderColor: 'var(--border)', color: 'var(--ink)' }}>
              Send Email
            </a>
            {helpEmail && <p className="text-xs mt-2 break-all" style={{ color: 'var(--slate)' }}>{helpEmail}</p>}
          </div>
        </div>
      </div>
    </div>
