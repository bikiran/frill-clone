          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border p-5" style={{ borderColor: 'var(--border)' }}>
              ...
              <div className="space-y-2">
                ...
                <a href="mailto:support@frill.co"
