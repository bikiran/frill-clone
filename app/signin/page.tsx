        ...
        <div className="bg-white rounded-2xl shadow-lg p-8" style={{ border: '1px solid var(--border)' }}>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full px-4 py-2.5 rounded-xl border flex items-center justify-center gap-3 text-sm font-medium hover:bg-gray-50 disabled:opacity-50 cursor-pointer transition-all"
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white" style={{ color: 'var(--slate)' }}>or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-sm font-medium" style={{ color: 'var(--ink)' }}>Password</label>
                  <Link href="/forgot-password" className="text-xs hover:underline" style={{ color: 'var(--coral)' }}>
                    Forgot password?
                  </Link>
                </div>
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3 rounded-lg font-semibold text-white cursor-pointer disabled:opacity-50 transition-all"
